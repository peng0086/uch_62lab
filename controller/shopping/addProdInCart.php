<?php
  ...
  function mergeData($pid, $count, $usernamet){
    ...
    include '../../DB/DB.php';
    $sql = "SELECT orderList FROM shoppingcart where username = '". $usernamet ."' ;";
    ...
    if($row = $result->fetch_assoc()) {
      ...
      $sql2 = "UPDATE shoppingcart SET orderList  = '". $temp ."' WHERE username = '".$usernamet."';";
      mysqli_query($conn, $sql2)?"update susses":"error";
      

    }else{
      $sql2 = "INSERT INTO shoppingcart (orderList ,username ) VALUES('[{\"productID\": ". $pid ." ,\"count\": ". $count ."}]','". $usernamet ."');";
